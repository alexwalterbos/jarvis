...
import com.awalterbos.jarvis.protocol.ProtocolOne;
import com.awalterbos.jarvis.protocol.ProtocolTwo;
...
public class GroupsBackend {
	...
	public Group findById(long id) {
		return groups.findByIdOrThrow(id);
	}
	...
	public void activate(long id) throws InterruptedException {
		Group group = groups.findByIdOrThrow(id);
	...
	public Group updateGroup(Group group) {
		Group fromDB = groups.findByIdOrThrow(group.getId());
